...
/* privacy-policy.html.twig */
class __TwigTemplate_20ba5d4a165ca8436cf79c42b1b2745a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "privacy-policy.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "privacy-policy.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "privacy-policy.html.twig", 1);
    ...
    <link rel=\"stylesheet\" href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("css/legal.css"), "html", null, true);
        echo "\">
";
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 15
        echo "<h1 class=\"title\">Politique de confidentialité</h1>
<h2 class=\"subtitle\">diet-coupart.eu </h2>

<div class=\"private-policy-container\">
    <h3 class=\"article-title\">ARTICLE 1 : PRÉAMBULE</h3>
    ...
    <h3 class=\"article-title\">ARTICLE 2 : PRINCIPES RELATIFS À LA COLLECTE ET AU TRAITEMENT DES DONNÉES PERSONNELLES</h3>  
    ...
    <h3 class=\"article-title\">ARTICLE 3 : DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE </h3>
    <h4 class=\"article-subtitle\">Article 3.1 : Données collectées</h4>
    <p>Les données personnelles collectées dans le cadre de notre activité sont les suivantes : nom, prénom, email, régimes, allergènes.</p> 
    <p>La collecte et le traitement de ces données répond à la finalité suivante : gestion de l’espace client et suivi de la qualité des services<br></p>

    <h4 class=\"article-subtitle\">Article 3.2 : Mode de collecte des données</h4>
    <p>Des données personnelles sont collectées lorsque vous effectuez les opérations suivantes sur la plateforme: envoie d'un message via le formulaire de contact et avis laissés sur les recettes.
    Les données collectées sont le nom, le prénom, et l'adresse e-mail de l'utilisateur.<br>
    Elles sont conservées par le responsable du traitement dans des conditions raisonnables de sécurité, jusqu'à arrêt du suivi par la diététicienne.<br>
    La société est susceptible de conserver certaines données à caractère personnel au-delà des délais annoncés ci-dessus afin de remplir ses obligations légales ou réglementaires.<br></p>

    <h4 class=\"article-subtitle\">Article 3.3 : Hébergement des données</h4>
    <p>Le site diet-coupart est hébergé par : Hostinger<br></p>

    <h3 class=\"article-title\">ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES ET DÉLÉGUÉ À LA PROTECTION DES DONNÉES</h3>
    <h4 class=\"article-subtitle\">Article 4.1 : Le responsable du traitement des données</h4>
    <p>Les données à caractère personnelles sont collectées par Sandrine Coupart.
    Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante : <br>
    Par courrier à l’adresse :  126 avenue de la Moune 14118 Caen; <br> 
    Par téléphone, au 02 61 53 00 35;<br>
    Par mail : sandrine_coupart@email.com.<br></p>

    <h4 class=\"article-subtitle\">Article 4.2 : Le délégué à la protection des données</h4>
    <p>Le délégué à la protection des données de l’entreprise ou du responsable est :<br>Sandrine Coupart, 126 avenue de la Moune 14118 Caen, 02 61 53 00 35;</p>

    <p>Si vous estimez, après nous avoir contactés, que vos droits “Informatique et Libertés”, ne sont pas respectés, vous pouvez adresser une information à la CNIL.<br></p>

    <h3 class=\"article-title\">ARTICLE 5 : LES DROITS DE L’UTILISATEUR EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DES DONNÉES</h3>
    ...
    <p>Pour exercer vos droits, veuillez adresser votre courrier à Sandrine Coupart, 126 avenue de la Moune 14118 Caen ou par mail à sandrine_coupart@hotmail.com;</p>
    ...
    <p>Consultez le site cnil.fr pour plus d’informations sur vos droits.<br></p>

    <h3 class=\"article-title\">ARTICLE 6 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ</h3>
    <p>L’éditeur du site diet-coupart se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.</p> 
    ...
    <p>La présente politique a été éditée le 20/04/2023.</p>

    <p class=\"italic-text\">Modèle réalisé sur LegalPlace.fr</p>
</div>
";
    ...
    {
        return "privacy-policy.html.twig";
    }
    ...
    {
        return array (  157 => 30,  140 => 15,  130 => 14,  117 => 11,  107 => 10,  95 => 7,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% endblock %}", "privacy-policy.html.twig", "C:\\Users\\erika\\Desktop\\diet-coupart\\diet-project\\templates\\privacy-policy.html.twig");
    }
}
