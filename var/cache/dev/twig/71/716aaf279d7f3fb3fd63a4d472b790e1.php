...
class __TwigTemplate_9611ac558b76f9effde64f326735cbd2 extends Template
{
...
";
    ...
    <div class=\"modal-dialog\">
        <div class=\"modal-content\">
            <div class=\"modal-header justify-content-between\">
                <button type=\"button\" data-bs-dismiss=\"modal\" class=\"btn btn-sm btn-secondary\" id=\"modal-clear-button\" formtarget=\"_self\">
                    <twig:ea:Icon name=\"internal:xmark\" /> {{ 'filter.button.clear'|trans(domain = 'EasyAdminBundle') }}
                </button>
                <h5 class=\"modal-title\">
                    <twig:ea:Icon name=\"internal:filter\" /> {{ 'filter.title'|trans(domain = 'EasyAdminBundle') }}
                </h5>
                <button type=\"button\" data-bs-dismiss=\"modal\" class=\"btn btn-sm btn-primary\" id=\"modal-apply-button\" formtarget=\"_self\">
                    <twig:ea:Icon name=\"internal:check\" /> {{ 'filter.button.apply'|trans(domain = 'EasyAdminBundle') }}
                </button>
            </div>
            <div class=\"modal-body p-0\">
...
", "@EasyAdmin/crud/includes/_filters_modal.html.twig", "C:\\Users\\erika\\Desktop\\diet-coupart\\diet-project\\vendor\\easycorp\\easyadmin-bundle\\templates\\crud\\includes\\_filters_modal.html.twig");
    }
}
