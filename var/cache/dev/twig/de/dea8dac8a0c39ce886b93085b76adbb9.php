...
class __TwigTemplate_8ccda9e9b0f4e3aac2edb699a7896bc8 extends Template
{
        ...
        if (((isset($context["show_flag"]) || array_key_exists("show_flag", $context) ? $context["show_flag"] : (function () { throw new RuntimeError('Variable "show_flag" does not exist.', 9, $this->source); })()) &&  !(isset($context["show_name"]) || array_key_exists("show_name", $context) ? $context["show_name"] : (function () { throw new RuntimeError('Variable "show_name" does not exist.', 9, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["flag_code"] => $context["country_name"]) {
                ...
                if ((($tmp =  !(null === $context["flag_code"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 12
                    yield "            <twig:ea:Flag countryCode=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["flag_code"], "html", null, true);
                    yield "\" height=\"17\" />
        ";
                }
                // line 14
...
";
    ...
    {
        return array (  107 => 29,  104 => 27,  102 => 26,  96 => 22,  94 => 21,  92 => 20,  90 => 19,  85 => 18,  79 => 16,  77 => 15,  71 => 14,  65 => 12,  62 => 11,  57 => 10,  55 => 9,  52 => 8,  50 => 7,  48 => 6,);
    }
...
{% else %}
    ...
    {% endfor %}
{% endif %}
", "@EasyAdmin/crud/field/country.html.twig", "C:\\Users\\erika\\Desktop\\diet-coupart\\diet-project\\vendor\\easycorp\\easyadmin-bundle\\templates\\crud\\field\\country.html.twig");
    }
}
