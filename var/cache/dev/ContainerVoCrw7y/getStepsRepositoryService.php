 ...
 */
class getStepsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StepsRepository' shared autowired service.
     *
     * @return \App\Repository\StepsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StepsRepository.php';

        return $container->privates['App\\Repository\\StepsRepository'] = new \App\Repository\StepsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
