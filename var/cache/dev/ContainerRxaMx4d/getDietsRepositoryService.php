 ...
 */
class getDietsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DietsRepository' shared autowired service.
     *
     * @return \App\Repository\DietsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DietsRepository.php';

        return $container->privates['App\\Repository\\DietsRepository'] = new \App\Repository\DietsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
